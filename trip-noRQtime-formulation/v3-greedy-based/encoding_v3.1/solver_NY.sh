...
if [ "$TEST" == "1" ]
then
    clingo-dl cp_path_2.lp opt.lp ../instance/init.lp ../instance/network_NY_1.lp ../instance/rq.lp time_schedule_2.lp
else
    echo "MAX_SEG=${MAX_SEGMENT} TIME-LIMIT=${TIME} AGENT=${AGENT} NETWORK=NY NO COST"
    clingo-dl cp_path_2.lp opt.lp ../instance/init.lp ../instance/network_NY_1.lp ../instance/rq.lp time_schedule_2.lp -c max_seg=$MAX_SEGMENT --time-limit=${TIME}
fi
